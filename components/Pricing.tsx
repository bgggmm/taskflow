          ...
          {plans.map((plan, i) => (
            <div key={i} className="relative pt-4">
              ...
              <motion.div
                ...
                className={`group relative rounded-3xl p-10 bg-white dark:bg-zinc-900 ${plan.popular ? "scale-105 shadow-2xl shadow-sky-500/20" : "shadow-xl"} overflow-hidden h-full flex flex-col min-h-112`}
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <ul className="space-y-4 mb-10 flex-1">
                    {plan.features.map((feature, idx) => (
                      ...
                      >
                        <div className={`w-6 h-6 rounded-full bg-linear-to-br ${plan.gradient} flex items-center justify-center shrink-0 group-hover/item:scale-110 transition-transform`}>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`w-full py-4 rounded-2xl font-semibold transition-all duration-300 relative overflow-hidden ${
                      plan.popular
                        ? "bg-linear-to-r from-sky-500 to-blue-600 text-white shadow-lg shadow-sky-500/30 hover:shadow-xl hover:shadow-sky-500/40"
                        : "border-2 border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-500"
                    }`}
                  >
                    {plan.popular && (
